    ...
    return (
        <main className="flex flex-col">
            ...
            <section className="pt-20 wrapper flex flex-col gap-10 h-full">
                <Headers title="Featured Travel Destinations" description="Check out some of the best places you visit around the world" />
            ...
            <section id="trips" className="py-20 wrapper flex flex-col gap-10">
                <Headers title="Handpicked Trips" description="Browse well-planned trips designes for your travel style" />
